...
\end{itemize}
\item There is a change of direction that these points
\end{itemize}
\end{frame}
...
You can start with two themes
\begin{itemize}[<+-| alert@+>]
\pause
\item Finding momentum 
\begin{itemize}
\item Finding trends
\item Start with a moving average
\end{itemize}
\item The end of the trend
\begin{itemize}
\item Finding a reversal
\item Start with a rolling standard deviation
\item This will identify large or extreme moves
\end{itemize}
\end{itemize}
\end{frame}
